...
#define SLV_GIT_CODE "GIT:38b3e45 08.22.2014"

#if SLV_FLIGHTMODE == HILSIM_MODE
	#define THISFIRMWARE "ArduPlane V2.27 GIT: 38b3e45 08.22.2014 Simulation"
#else
	#define THISFIRMWARE "ArduPlane V2.27 GIT: 38b3e45 08.22.2014 Flight"
#endif
