...
// Vehicle Parameters
// ------------------
#define THISVEHICLE		"N801RE"
#define THISFLIGHTMODE	"Flight Mode"
#define AIRFRAME_NAME	"R1 Edge"
...
#define	CH_1_OFFSET  0
#define	CH_2_OFFSET  0
#define	CH_3_OFFSET  0
#define	CH_4_OFFSET  0
#define	CH_5_OFFSET  0
#define	CH_6_OFFSET  0
#define	CH_7_OFFSET  0
#define	CH_8_OFFSET  0
...
#define ANALOG_EU_01        (float)(g.channel_roll.radio_in)
#define ANALOG_EU_02        (float)(ac_ch[0]*0.0057 + 15.185)
#define ANALOG_EU_03        (float)(ac_ch[2]*0.0114 + 30.411 - (ac_ch[0]*0.0057 + 15.185))
#define ANALOG_EU_04        (float)((ac_ch[4]-20)*0.116745 - 0.342121)
#define ANALOG_EU_05        (float)(ac_ch[7]*(8.2474 -0.0015*(float)ac_ch[7]) -226.1756)
#define ANALOG_EU_06        (float)(g.channel_pitch.radio_in)
#define ANALOG_EU_07        (float)(ac_ch[1]*0.0057 + 15.285)
#define ANALOG_EU_08        (float)(ac_ch[3]*0.0114 + 30.428 - (ac_ch[1]*0.0057 + 15.285))
#define ANALOG_EU_09        (float)((ac_ch[5]-20)*0.116191 - 0.339012)
#define ANALOG_EU_10        (float)(ac_ch[6]*(7.6758 -0.0012*(float)ac_ch[6]) -239.5337)
#define ANALOG_EU_11        (float)(WptRadius)
#define ANALOG_EU_12        (float)(ac_ch[6]*(7.6758 -0.0012*(float)ac_ch[6]) -239.5337)
#define ANALOG_EU_13        (float)((ac_ch[4]-20)*0.116745 - 0.342121)
#define ANALOG_EU_14        (float)((ac_ch[5]-20)*0.116191 - 0.339012)
#define ANALOG_EU_15        (float)(ac_ch[6]*(7.6758 -0.0012*(float)ac_ch[6]) -239.5337)
#define ANALOG_EU_16        (float)(ac_ch[15] * (1.0)         + (0.0))
