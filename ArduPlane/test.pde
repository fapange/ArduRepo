...
test_passthru(uint8_t argc, const Menu::arg *argv)
{
	...
	while(1){
        ...
        if (APM_RC.GetState() == 1){
            Serial.print("CH:");
                Serial.print(APM_RC.InputCh(CH_1));  Serial.print(",");  APM_RC.OutputCh(CH_1, APM_RC.InputCh(CH_1)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_2));  Serial.print(",");  APM_RC.OutputCh(CH_2, APM_RC.InputCh(CH_2)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_3));  Serial.print(",");  APM_RC.OutputCh(CH_3, APM_RC.InputCh(CH_3)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_4));  Serial.print(",");  APM_RC.OutputCh(CH_4, APM_RC.InputCh(CH_4)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_5));  Serial.print(",");  APM_RC.OutputCh(CH_5, APM_RC.InputCh(CH_5)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_7));  Serial.print(",");  APM_RC.OutputCh(CH_7, APM_RC.InputCh(CH_7)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_6));  Serial.print(",");  APM_RC.OutputCh(CH_6, APM_RC.InputCh(CH_6)); // Copy input to Servos
                Serial.print(APM_RC.InputCh(CH_8));  Serial.print(",");  APM_RC.OutputCh(CH_8, APM_RC.InputCh(CH_8)); // Copy input to Servos
			Serial.println();
        }
        if (Serial.available() > 0){
            return (0);
