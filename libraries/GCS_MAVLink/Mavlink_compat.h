...
static void mavlink_msg_wID_global_position_int_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, uint32_t time_boot_ms, int32_t lat, int32_t lon,
...
static void mavlink_msg_wID_rc_channels_scaled_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, uint32_t time_boot_ms, uint8_t port,
...
static void mavlink_msg_wID_rc_channels_raw_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, uint32_t time_boot_ms, uint8_t port,
...
static void mavlink_msg_wID_servo_output_raw_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, uint32_t time_usec, uint8_t port,
...
static void mavlink_msg_wID_statustext_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, uint8_t severity, const char *text)
{
        mavlink_msg_wID_statustext_send(chan, sID, cID, severity, (const int8_t*) text);
}

static void mavlink_msg_wID_param_value_send(mavlink_channel_t chan, uint8_t sID, uint8_t cID, const char *param_id,
