...
{ \
  ...
  { \
    ...
    { "led_blue", NULL, MAVLINK_TYPE_UINT8_T, 4, 6, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, led_blue) }, \
    { "led_green", NULL, MAVLINK_TYPE_UINT8_T, 4, 10, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, led_green) }, \
    { "roll", NULL, MAVLINK_TYPE_INT16_T, 4, 14, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, roll) }, \
    { "pitch", NULL, MAVLINK_TYPE_INT16_T, 4, 22, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, pitch) }, \
    { "yaw", NULL, MAVLINK_TYPE_INT16_T, 4, 30, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, yaw) }, \
    { "thrust", NULL, MAVLINK_TYPE_UINT16_T, 4, 38, offsetof(mavlink_set_quad_swarm_led_roll_pitch_yaw_thrust_t, thrust) }, \
  } \
}
	...
	)
{
	...
	_mav_put_uint8_t_array(buf, 6, led_blue, 4);
	_mav_put_uint8_t_array(buf, 10, led_green, 4);
	_mav_put_int16_t_array(buf, 14, roll, 4);
	_mav_put_int16_t_array(buf, 22, pitch, 4);
	_mav_put_int16_t_array(buf, 30, yaw, 4);
	_mav_put_uint16_t_array(buf, 38, thrust, 4);

	memcpy(_MAV_PAYLOAD(msg), buf, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN);
#else
	...
	memcpy(_MAV_PAYLOAD(msg), &packet, MAVLINK_MSG_ID_SET_QUAD_SWARM_LED_ROLL_PITCH_YAW_THRUST_LEN);
#endif
...
{
	return _MAV_RETURN_uint8_t_array(msg,led_blue,4,6);
}
...
{
	return _MAV_RETURN_uint8_t_array(msg,led_green,4,10);
}
...
{
	return _MAV_RETURN_int16_t_array(msg,roll,4,14);
}
...
{
	return _MAV_RETURN_int16_t_array(msg,pitch,4,22);
}
...
{
	return _MAV_RETURN_int16_t_array(msg,yaw,4,30);
}
...
{
	return _MAV_RETURN_uint16_t_array(msg,thrust,4,38);
}
