...
/**************************************************/
void
#if SLV_AP_DCM_PITCHOFFSET == ENABLED
	AP_DCM::update_DCM(long pitch_offset_degx100)
#else
	#error SLV_AP_DCM_PITCHOFFSET DISABLED.
...
#if SLV_AP_DCM_PITCHOFFSET == ENABLED
	euler_angles(pitch_offset_degx100);	// Calculate pitch, roll, yaw for stabilization and navigation
#else
	#error SLV_AP_DCM_PITCHOFFSET DISABLED.
...
void
#if SLV_AP_DCM_PITCHOFFSET == ENABLED
	AP_DCM::euler_angles(long pitch_offset_degx100)
#else
	#error SLV_AP_DCM_PITCHOFFSET DISABLED.
...
#if SLV_AP_DCM_PITCHOFFSET == ENABLED
	pitch += (pitch_offset_degx100 * RADX100);
#else
	#error SLV_AP_DCM_PITCHOFFSET DISABLED.
#endif
