...
namespace hud
{
  ...
  System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float sensorcalStatus { get; set; }
        
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public byte hudVehicle { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public byte hudLoiter { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float hudMUX { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public byte hudRC_state { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public byte hudMode { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public byte numWpts { get; set; }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float hudOdometer { get; set; }
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public float wpradius { get { return _wpradius; } set { if (_wpradius != value) { _wpradius = value; this.Invalidate(); } } }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        ...
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        public int selectedAircraft { get { return _selectedAircraft; } set { if (_selectedAircraft != value) { _selectedAircraft = value; this.Invalidate(); } } }
        [System.ComponentModel.Browsable(true), System.ComponentModel.Category("Values")]
        ...
        static DateTime blinktimer = DateTime.Now;
        void doPaint(PaintEventArgs e)
        {
            ...
            try
            {
...
#if SLV_ADDED
                SolidBrush redBrush = new SolidBrush(redPen.Color);
                SolidBrush greenBrush = new SolidBrush(greenPen.Color);
#endif
                ...
                else if (hudRC_state == 128)
                    drawstring(graphicsObject, "ENGINE OFF", font, fontsize + 20, Brushes.Red, -70, halfheight / -3);
                ...
                if (sensorcalStatus < 0)
                {
                    if (blink)
                    {
                        ...
                        //drawstring(graphicsObject, "SENSOR CALIBRATION OFFSET", font, fontsize + 5, Brushes.Red, centercircle.Left - 170, centercircle.Top-17);
                    }
                    if (DateTime.Now > blinktimer.AddSeconds(1.0))
                    {
                        blink = !blink;
                ...
                float speed;
                if (ArdupilotMega.MainV2.useGrndSpd)
                    speed = _groundspeed;
                else
                    speed = _airspeed;
...
#if SLV_nADDED
                start = ((int)ArdupilotMega.MainV2.config["ARSPD_FBW_MIN"] - viewrange / 2);

                if (start > _targetspeed)
                {
                    redPen.Color = Color.FromArgb(200, redPen.Color);
                    redPen.Width = 6;
                    graphicsObject.DrawLine(redPen, scrollbg.Left, scrollbg.Top, scrollbg.Left + scrollbg.Width, scrollbg.Top);
                    redPen.Color = Color.FromArgb(255, redPen.Color);
                }
                if ((groundspeed + viewrange / 2) < _targetspeed)
                {
                    redPen.Color = Color.FromArgb(200, redPen.Color);
                    redPen.Width = 6;
                    graphicsObject.DrawLine(redPen, scrollbg.Left, scrollbg.Top - space * viewrange, scrollbg.Left + scrollbg.Width, scrollbg.Top - space * viewrange);
                    redPen.Color = Color.FromArgb(255, redPen.Color);
                }
#endif
...
#if SLV_ADDED
                // extra text data
                drawstring(graphicsObject, "AS " + _airspeed.ToString("0.0"), font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 0 * (fontsize + 7));
                drawstring(graphicsObject, "GS " + _groundspeed.ToString("0.0"), font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 1 * (fontsize + 7));
                drawstring(graphicsObject, _batteryremaining.ToString("CPU 0%"), font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 2 * (fontsize + 7));
                switch (_selectedAircraft)
                {
                    case SLV_N801RE:
                        drawstring(graphicsObject, "N801RE", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N802RE:
                        drawstring(graphicsObject, "N802RE", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N803RE:
                        drawstring(graphicsObject, "N803RE", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_HILPLANE:
                        drawstring(graphicsObject, "Hil_Plane", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N381NA:
                        drawstring(graphicsObject, "N381NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N382NA:
                        drawstring(graphicsObject, "N382NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N383NA:
                        drawstring(graphicsObject, "N383NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N384NA:
                        drawstring(graphicsObject, "N384NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N385NA:
                        drawstring(graphicsObject, "N385NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N386NA:
                        drawstring(graphicsObject, "N386NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    case SLV_N387NA:
                        drawstring(graphicsObject, "N387NA", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                    default:
                        drawstring(graphicsObject, "Unknown Aircraft", font, fontsize, whiteBrush, 1, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                        break;
                }
                ...
                else if (_gpsfix == 1) gps = ("GPS: No Fix");
                else if (_gpsfix == 2) gps = ("GPS: 3D Fix");
                else if (_gpsfix == 3) gps = ("GPS: 3D Fix");
                int nchars = 10;
                drawstring(graphicsObject, _mode, font, fontsize, whiteBrush, this.Width - nchars * fontsize, scrollbg.Bottom + 5 + 0 * (fontsize + 7));
                drawstring(graphicsObject, (int)(_disttowp - _wpradius) + "> (" + (int)_wpradius + " [" + _wpno + "]", font, fontsize, whiteBrush, this.Width - nchars * fontsize, scrollbg.Bottom + 5 + 1 * (fontsize + 7));
                drawstring(graphicsObject, "time left " + time_left, font, fontsize, whiteBrush, this.Width - nchars * fontsize, scrollbg.Bottom + 5 + 2 * (fontsize + 7));
                if (time_left > 1)
                {
                    nspeed = ((_disttowp - _wpradius) / time_left);
                    //float Maxs = float.Parse(ArdupilotMega.MainV2.comPort.param["AIRSPEED_FBW_MAX"].ToString());
                    //float Mins = float.Parse(ArdupilotMega.MainV2.comPort.param["AIRSPEED_FBW_MIN"].ToString());
                    //nspeed = nspeed > Maxs ? Maxs : nspeed < Mins ? Mins : nspeed;
                }
                drawstring(graphicsObject, "speed " + nspeed.ToString("0.0"), font, fontsize, whiteBrush, this.Width - nchars * fontsize, scrollbg.Bottom + 5 + 3 * (fontsize + 7));
                drawstring(graphicsObject, gps, font, fontsize + 2, whiteBrush, this.Width - nchars * fontsize, scrollbg.Bottom + 5 + 4 * (fontsize + 7));
#else
