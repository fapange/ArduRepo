...
//#endif
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    routes.Markers.Add(new GMapMarkerPlane(currentloc, MainV2.cs.yaw, MainV2.cs.groundcourse, MainV2.cs.nav_bearing, MainV2.cs.target_bearing, MainV2.cs.geoWeight, MainMap) { ToolTipText = MainV2.cs.alt.ToString("0"), ToolTipMode = MarkerTooltipMode.Always });
                }
                else
                {
